...
description: Obsidianのデイリーノートでロギングしているけれど、何か違う…？この記事では、日記アプリとして有名な「DayOne」を、日々の出来事を記録する「日誌」として活用する新しいアプローチを紹介します。入力のしやすさ、自動メタデータ記録、優れた見返し機能といったDayOneのメリットを活かしつつ、Obsidianとはどう使い分けるのか。デイリータスクリストはObsidian、日々のログはDayOne。二つのデイリーノートを使い分けることで実現する、快適な情報管理術です。
