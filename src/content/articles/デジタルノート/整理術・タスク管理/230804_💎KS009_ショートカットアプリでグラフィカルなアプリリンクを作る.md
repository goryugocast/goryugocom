...
description: 記事では、Obsidianでグラフィカルなアプリリンクを作成する方法として、Appleのショートカットアプリを活用する手法を紹介。プラグインと比較し、Markdownの簡潔さと視覚的満足度を両立する利点を解説しています。
