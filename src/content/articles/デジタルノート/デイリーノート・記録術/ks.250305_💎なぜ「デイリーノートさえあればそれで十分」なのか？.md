---
project: ks
topic: ['Obsidian', 'デイリーノート', 'ノート術']
topic_code: obs
title: なぜ「デイリーノートさえあればそれで十分」なのか？
subtitle: "\U0001F48Eアトミック・シンキング実践ワークシートより抜粋"
description: Obsidianのデイリーノート活用術。フォルダ整理やキーワード検索の非効率性を指摘し、日付を基準に全てのメモをデイリーノートに集約するシンプルかつ強力な整理法を提唱。書くことで考える第一歩。
url: 'https://knowledgestuck.substack.com/p/obsidian-043'
...
デイリーノートという仕組みは、ほとんど整理が不要でありながら、必要に応じて目的のメモを見つけることも簡単にできるという、**現状考えられるもっとも優れた整理システムの1つ**なのです。
...
[Obsidianでアトミック・シンキングを実践するためのテンプレートを作りました - by goryugo](https://knowledgestuck.substack.com/p/obsidian-458)
