...
- [[210201_💭_10分かける価値があることは全て「Anki」する]]
    - 「何をAnkiに入れるべきか」という私の基本的な判断基準となる哲学です。
- [[Ankiデッキは一つの大きなものを使う]]
    - 記事内で触れた「デッキを分けずに一つにする運用」についての詳細な解説。
- [[Obsidian_to_Anki]]
    - ObsidianとAnkiを連携させるための具体的な設定方法はこちら。
- [[Ankiによる記憶は学習の第一歩であり知識の活用や体系化は別次元の思考を必要とする]]
    - 記憶するだけでは不十分であり、そこからどう活用するかという視点。
- [[221210_📮_Anki問題作りは「究極のアトミックノート」作り]]
